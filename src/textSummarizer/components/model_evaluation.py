...
class ModelEvaluation:
    ...
    def generate_batch_sized_chunks(self, list_of_elements, batch_size):
        for j in range(0, len(list_of_elements), batch_size):
          yield list_of_elements[j:j + batch_size]
    ...
    def evaluate(self):
        ...
        score = self.calculate_metrics_on_test_ds(dataset_samsum_pt['test'][:10], rouge_metric,
                                                  model, tokenizer, 2, device)
